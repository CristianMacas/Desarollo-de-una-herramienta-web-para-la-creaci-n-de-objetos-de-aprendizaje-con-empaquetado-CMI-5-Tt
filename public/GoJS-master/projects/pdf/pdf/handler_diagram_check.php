...
try{
    ...
    $result = mysqli_query($conection, "insert into model_diagram_test values (NULL, '".$data->course_id."', '".$data->nactivity_id."', '".$user_name."', '".json_encode($data->diagramModel, JSON_UNESCAPED_UNICODE)."')");
    $conection->close();
