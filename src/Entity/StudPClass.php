...
/**
 * @ORM\Entity(repositoryClass=StudPClassRepository::class)
 */
class StudPClass
{
    /**
   ...
   /**
    ...
    /**
     * @ORM\ManyToMany(targetEntity=Atribute::class, inversedBy="studPClasses",cascade={"all"})
     */
    private $atribute;

    /**
     * @ORM\ManyToMany(targetEntity=Operation::class, inversedBy="studPClasses",cascade={"all"})
     */
    private $operation;
