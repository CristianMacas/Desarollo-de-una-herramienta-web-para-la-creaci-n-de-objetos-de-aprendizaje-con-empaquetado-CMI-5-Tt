...
/**
 * @extends ServiceEntityRepository<Atribute>
 *
 ...
 */
class AtributeRepository extends ServiceEntityRepository
{
    public function __construct(ManagerRegistry $registry)
    {
        parent::__construct($registry, Atribute::class);
    }
     ...
     */
    public function add(Atribute $entity, bool $flush = true): void
    {
     ...
     * @throws OptimisticLockException
     */
    public function remove(Atribute $entity, bool $flush = true): void
    {
