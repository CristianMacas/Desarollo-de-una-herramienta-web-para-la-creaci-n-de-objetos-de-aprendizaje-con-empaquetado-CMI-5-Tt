 ...
 */
final class Version20220614165057 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE operation ADD datatype_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE operation ADD CONSTRAINT FK_1981A66D5C815A09 FOREIGN KEY (datatype_id) REFERENCES datatype (id)');
        $this->addSql('CREATE INDEX IDX_1981A66D5C815A09 ON operation (datatype_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_1981A66D5C815A09 ON operation');
        $this->addSql('ALTER TABLE operation DROP datatype_id');
    }
}
